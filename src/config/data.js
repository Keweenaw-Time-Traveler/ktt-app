const Api = {
  GRID: 'http://geospatialresearch.mtu.edu/grid.php',
  GRID_CELL: 'http://geospatialresearch.mtu.edu/grid_cell.php',
  MARKERS: 'http://geospatialresearch.mtu.edu/markers.php',
  MARKER_INFO: 'http://geospatialresearch.mtu.edu/marker_info.php',
  MAP_PICKER: 'http://geospatialresearch.mtu.edu/map_picker.php',
